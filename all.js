...
function World11(e) {
    ...
    e.areas = [new Area("Overworld",(function() {
        ...
        pushPreThing(Koopa, 340, 8),
        pushPrePipe(368, 0, 32),
        pushPreThing(Koopa, 412, 8),
        pushPreThing(Koopa, 422, 8),
        ...
        pushPreThing(Koopa, 640, jumplev1 + 8),
