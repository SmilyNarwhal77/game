...
function World11(e) {
    ...
    e.areas = [new Area("Overworld",(function() {
        ...
        e += "'>",
        e += "  <p style='text-align:left;padding:7px 0 11px 11px;color:#ffcccc;font-family: "Ubuntu",Serif;font-size:77px;text-shadow:3px 8px black'>",
        e += "    <span style='font-size:40px'>Mario's</span>",
        e += "    <br><br>",
        e += "    <span style='font-size:40px;line-height:96px;font-family: "Ubuntu",Serif;'>Recycling Adventure</span>",
        e += "  </p>",
        e += "</div>",
