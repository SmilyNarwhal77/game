    ...
    window.library = {
        rawsprites: {
            characters: {
                ...
                Beetle: {
                    normal: {
                        normal: "p[0,2,5,8]x022,1111x010,x18,x07,x110,x05,x17,33111000x18,32311000x19,3311003333x111,001223x110,003203x110,011213x110,011113x110,011113x110,0011233x15,x35,00222331133322200222203333002222",
                        two: "p[0,2,5,8]x07,111x010,x18,x07,x110,x05,x17,33111000x18,32311000x19,3311120333x111,001133x110,001113x110,011213x110,011113x110,011113x110,0011233x15,x35,00022331133322x05,22233330222x06,22x05,22000"
                    },
                    Underworld: {
                ...
                Coin: {
                    normal: {
                        normal: {
                            normal: "p[0,2,6,8]00222211000x26,11002233221102232212202031230223120232122112232212211223221221122322122112232212211223221221102211221100x26,1100022221100",
                        ...
                        Underworld: {
                            normal: "p[0,6,9,16]00111133000x16,33001122113301121132453102113113311211311331121131133112113113311211311331121131133112113113301133113300x16,3300011113300",
                ...
                FireFlower: {
                    normal: {
                        normal: "p[0,1,6,8,14]0000x18,x06,x112,000111x28,111011222x36,2221111112x36,222110111x28,111000x112,x06,x18,x011,44x07,444000044000044404440004400044400444400440044440004444044044440000444404404444x05,x410,x09,4444x06,",
                ...
                Goomba: {
                    normal: "p[0,2,5,9]x06,3333x011,x36,x09,x38,x07,x310,x05,311x36,11200033321333312333003332x16,23330333321233212x38,22233222x320,03333x26,3333x05,x28,x06,11x28,x05,x15,x25,110000x16,222111x05,x15,001110000",
                ...
                HammerBro: {
                    normal: {
                        normal: "p[0,1,6,14]003333x011,31x35,x08,31113313x09,31133313x08,311x35,x07,221221233x07,x25,122133x05,x25,12222133x06,21231x36,00022210311133313x06,3322113231x06,3222212331x06,x25,1323130000x25,1133233000x25,1133332200x25,313333233x06,33123323330000223311223333000022233111133x05,222x35,11110000222233x26,x05,222033x25,x06,2200002222x013,222",
                    ...
                    throwing: {
                        normal: "p[0,1,6,14]00003333x011,333313x09,3113331x010,31133332x07,231133322x06,x25,12322x06,x25,12222x06,x25,1122133x05,2221x25,333x07,1322223313x06,3322223231x06,33x25,331x06,33322132313x05,33311133233x05,3331x35,22x06,3313333233x06,33123323330000223311223333000022233111133x05,222x35,11110000222233x26,x05,222033x25,x06,2200002222x013,222",
                    ...
                    thrown: {
                        normal: "p[0,1,6,14]003333x011,31x35,x08,31113313x09,31133313x08,311x35,x07,221221233x07,x25,122133x05,x25,12231333x06,21231x36,00022210311133313x06,3322113231x06,3222212331x06,x25,1323130000x25,1133233000x25,1133332200x25,313333233x06,33123323330000223311223333000022233111133x05,222x35,11110000222233x26,x05,222033x25,x06,2200002222x013,222",
                ...
                Koopa: {
                    normal: {
                        normal: {
                            flying: {
                                normal: "p[0,1,6,14]x019,1x09,11000111x07,1111001112x05,x15,0231122000x15,00231122321322110002311220012111100211122011211110222122201211110023x25,012111010x26,0012x15,022202203312111002200220331113330220221333232333002022133233323200002212x36,23000221132x35,2300002132323332320000212333232333x05,1x35,23333x05,113332323111000221112331110000x25,x15,22200x25,x06,2222",
                            ...
                            normal: {
                                normal: {
                                    normal: "p[0,1,6,14]x019,1x014,111x013,1112x011,231122x010,231122x010,231122x010,211122x09,2221222x09,23x25,x09,x26,00x35,0002323430323332300220022033232333022022133332311300202213332323130000221232333232000221132x35,2300002132323332320000212333232333x05,1x35,23333x05,113332323111000221112331110000x25,x15,22200x25,x06,2222",
                                ...
                                Underworld: {
                                    ...
                                    two: "p[0,5,9,16]00001x014,111x012,2111x012,23112x010,223112x010,223112x010,221112x09,2322122x09,x27,x09,200220220x35,00022000213233323x06,2213323233x05,22133332311300222213332323130002221232333232000021132x35,2300002132323332320000212333232333x05,1x35,23333x05,113332323111000021112331112x05,222x15,222x06,2220000222x07,2220022200"
                                }
                            }
                        },
                ...
                Lakitu: {
                    normal: "p[0,1,6,14]x05,x25,x010,x27,x08,333233322x06,3111311132x06,3x17,323x05,3113131320102310311313113233x05,3332x37,x05,222333322233000x25,33x25,3003x25,11x25,30031222111122213003x112,303x114,33x15,3113x15,33x15,3113x15,33x15,3113x15,33x114,3313x110,3130311131111311130031111333311113003x112,3000311113311113x05,3333003333000",
                    hiding: "p[0,1,6,14]x0131,2220000222x05,x25,33x25,0000x25,11x25,00003232111122230003x112,303x114,33x15,3113x15,33x15,3113x15,33x15,3113x15,33x114,3313x110,3130311131111311130031111333311113003x112,3000311113311113x05,3333003333000"
                },
                Mario: {
                ...
                Mushroom: {
                    normal: "p[0,1,6,8]x06,2222x011,332222x09,32232322x07,x35,x25,x05,22333x27,000x29,3332200x28,x35,202233x25,x35,222333x25,x35,22233x27,333x219,02333x16,3332x05,x18,x08,12x16,x08,12x16,x09,121111x05,",
                ...
                Pirhana: {
                    normal: {
                        normal: "p[0,6,14]x022,2002x011,210012x09,22200222x08,12200221x07,2221001222x06,2222002222x05,1212200221210000x25,00x25,0000222120021222002010201002221200002222100122220000212220022212x05,2212002122x06,2222002222x07,12100121x010,2002x06,11x05,11x05,11121100011000112101211001100112100112110110112110001121011012110000111211112111x05,x110,000",
                    ...
                    Underworld: {
                        normal: "p[0,9,16]x022,2002x011,210012x09,22200222x08,12200221x07,2221001222x06,2222002222x05,1212200121210000x25,00x25,0000222120021222000021222002221200002222100122220000212220022212x05,2212002122x06,2222002222x07,12100121x010,2002x06,11x05,11x05,11121100011000112101211001100112100112110110112110001121011012110000111211112111x05,x110,000",
...
function endLevel() {
    ...
    1 == currentmap[0] && 1 == currentmap[1] && data.score.amount >= 5e10 && OpenModal(),
...
function World11(e) {
    ...
    e.areas = [new Area("Overworld",(function() {
        ...
        e += "    <span style='font-size:40px;line-height:60px;font-family: \'Ubuntu\', sans-serif;'>Goofy</span>",
        ...
        pushPreThing(Goomba, 640, jumplev1 + 8),
        pushPreThing(Goomba, 648, jumplev1 + 8),
        pushPreThing(Brick, 648, jumplev2),
        pushPreThing(Brick, 656, jumplev2),
        pushPreThing(Goomba, 656, jumplev2 + 8),
        pushPreThing(Goomba, 664, jumplev2 + 8),
        ...
        pushPreThing(Goomba, 772, 10),
        pushPreThing(Goomba, 780, 10),
        pushPreThing(Goomba, 788, 10),
